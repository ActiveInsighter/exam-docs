...
**[《代码随想录》算法视频公开课](https://programmercarl.com/about/gongkaike.html)：[图论：学透最短路算法之Bellman-ford算法（队列优化） | 贝尔曼-福特算法（队列优化）](https://www.bilibili.com/video/BV1YehwzdEVT/),相信结合视频再看本篇题解，更有助于大家对本题的理解**。
