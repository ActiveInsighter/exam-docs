...
我在[数组：每次遇到二分法，都是一看就会，一写就废](https://programmercarl.com/algo/other/0035-search-insert-position.html)和[数组：这个循环可以转懵很多人！](https://programmercarl.com/algo/array/0059-spiral-matrix-ii.html)中都强调过循环不变量的重要性，在二分查找以及螺旋矩阵的求解中，坚持循环不变量非常重要，本题也是。
