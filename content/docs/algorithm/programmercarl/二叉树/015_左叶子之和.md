...
![404.左叶子之和](https://file1.kamacoder.com/i/algo/20210204151949672.png)**其实是0，因为这棵树根本没有左叶子！**
...
本题迭代法使用前中后序都是可以的，只要把左叶子节点统计出来，就可以了，那么参考文章[二叉树：听说递归能做的，栈也能做！](https://programmercarl.com/algo/binary-tree/iterative-binary-tree-traversal.html)和[二叉树：迭代法统一写法](https://programmercarl.com/algo/binary-tree/unified-iterative-binary-tree-traversal.html)中的写法，可以写出一个前序遍历的迭代法。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Swift","C","Scala","Rust","C#"]}>
<Tab>
