...
pre指针的使用技巧，我们在[二叉树：搜索树的最小绝对差](https://programmercarl.com/algo/binary-tree/0530-minimum-absolute-difference-in-bst.html)和[二叉树：我的众数是多少？](https://programmercarl.com/algo/binary-tree/0501-find-mode-in-binary-search-tree.html)都提到了，这是常用的操作手段。
...
迭代法其实就是中序模板题了，在[二叉树：前中后序迭代法](https://programmercarl.com/algo/binary-tree/iterative-binary-tree-traversal.html)和[二叉树：前中后序统一方式迭代法](https://programmercarl.com/algo/binary-tree/unified-iterative-binary-tree-traversal.html)可以选一种自己习惯的写法。
