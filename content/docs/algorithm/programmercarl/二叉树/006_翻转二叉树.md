...
对于二叉树的递归法的前中后序遍历，已经在[二叉树：前中后序递归遍历](https://programmercarl.com/algo/binary-tree/recursive-binary-tree-traversal.html)详细讲解了。
...
[二叉树：听说递归能做的，栈也能做！](https://programmercarl.com/algo/binary-tree/iterative-binary-tree-traversal.html)中给出了前中后序迭代方式的写法，所以本题可以很轻松的写出如下迭代法的代码：
...
如果这个代码看不懂的话可以再回顾一下[二叉树：听说递归能做的，栈也能做！](https://programmercarl.com/algo/binary-tree/iterative-binary-tree-traversal.html)。

我们在[二叉树：前中后序迭代方式的统一写法](https://programmercarl.com/algo/binary-tree/unified-iterative-binary-tree-traversal.html)中介绍了统一的写法，所以，本题也只需将文中的代码少做修改便可。
...
如果上面这个代码看不懂，回顾一下文章[二叉树：前中后序迭代方式的统一写法](https://programmercarl.com/algo/binary-tree/unified-iterative-binary-tree-traversal.html)。
...
如果对以上代码不理解，或者不清楚二叉树的层序遍历，可以看这篇[二叉树：层序遍历登场！](https://programmercarl.com/algo/binary-tree/0102-binary-tree-level-order-traversal.html)
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","C","Swift","Rust","C#"]}>
<Tab>
