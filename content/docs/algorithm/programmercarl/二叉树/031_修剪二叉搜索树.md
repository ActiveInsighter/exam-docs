...
这样的做法在[二叉树：搜索树中的插入操作](https://programmercarl.com/algo/binary-tree/0701-insert-into-a-binary-search-tree.html)和[二叉树：搜索树中的删除操作](https://programmercarl.com/algo/binary-tree/0450-delete-node-in-a-bst.html)中大家已经了解过了。
