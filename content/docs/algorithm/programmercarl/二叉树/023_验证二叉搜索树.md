...
注意递归函数要有bool类型的返回值， 我们在[二叉树：递归函数究竟什么时候需要返回值，什么时候不要返回值？](https://programmercarl.com/algo/binary-tree/0112-path-sum.html)中讲了，只有寻找某一条边（或者一个节点）的时候，递归函数会有bool类型的返回值。
...
可以用迭代法模拟二叉树中序遍历，对前中后序迭代法生疏的同学可以看这两篇[二叉树：听说递归能做的，栈也能做！](https://programmercarl.com/algo/binary-tree/iterative-binary-tree-traversal.html)，[二叉树：前中后序迭代方式统一写法](https://programmercarl.com/algo/binary-tree/unified-iterative-binary-tree-traversal.html)
...
在[二叉树：二叉搜索树登场！](https://programmercarl.com/algo/binary-tree/0700-search-in-a-binary-search-tree.html)中我们分明写出了痛哭流涕的简洁迭代法，怎么在这里不行了呢，因为本题是要验证二叉搜索树啊。
