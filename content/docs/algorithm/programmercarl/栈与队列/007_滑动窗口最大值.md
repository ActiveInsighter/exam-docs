...
![](https://file1.kamacoder.com/i/algo/239.滑动窗口最大值.png)
...
使用deque最为合适，在文章[栈与队列：来看看栈和队列不为人知的一面](https://programmercarl.com/algo/stack-queue/stack-and-queue-basics.html)中，我们就提到了常用的queue在没有指定容器的情况下，deque就是默认底层容器。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Swift","Scala","PHP","C#","Rust","C++","C"]}>
<Tab>
