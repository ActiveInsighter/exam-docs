...
1. 第一种情况，字符串里左方向的括号多余了 ，所以不匹配。![括号匹配1](https://file1.kamacoder.com/i/algo/2020080915505387.png)
2. 第二种情况，括号没有多余，但是 括号的类型没有匹配上。![括号匹配2](https://file1.kamacoder.com/i/algo/20200809155107397.png)
3. 第三种情况，字符串里右方向的括号多余了，所以不匹配。![括号匹配3](https://file1.kamacoder.com/i/algo/20200809155115779.png)
...
<Tabs items={["Java","Python","Go","Ruby","JavaScript","TypeScript","Swift","C","C#","PHP","Scala","Rust"]}>
<Tab>
