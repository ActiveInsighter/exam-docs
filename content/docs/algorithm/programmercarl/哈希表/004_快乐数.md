...
正如：[关于哈希表，你该了解这些！](https://programmercarl.com/algo/hash-table/hash-table-basics.html)中所说，**当我们遇到了要快速判断一个元素是否出现集合里的时候，就要考虑哈希法了。**
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Swift","PHP","Rust","C","Scala","C#","Ruby"]}>
<Tab>
