...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Swift","Rust","C","C#","PHP","Scala"]}>
<Tab>
...
[上一篇：移除元素](https://programmercarl.com/algo/array/0027-remove-element.html)·[返回双指针学习路线](https://programmercarl.com/algo/two-pointers/)·[下一篇：替换数字](https://programmercarl.com/algo/string/kamacoder-0054-replace-digits.html)
