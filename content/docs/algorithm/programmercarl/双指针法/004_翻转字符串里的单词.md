...
如果以上代码看不懂，建议先把[27.移除元素](https://programmercarl.com/algo/array/0027-remove-element.html)这道题目做了，或者看视频讲解：[数组中移除元素并不容易！LeetCode：27. 移除元素](https://www.bilibili.com/video/BV12A4y1Z7LP)。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Swift","Scala","PHP","Rust","C","C#"]}>
<Tab>
...
[上一篇：替换数字](https://programmercarl.com/algo/string/kamacoder-0054-replace-digits.html)·[返回双指针学习路线](https://programmercarl.com/algo/two-pointers/)·[下一篇：翻转链表](https://programmercarl.com/algo/linked-list/0206-reverse-linked-list.html)
