...
- [206.翻转链表](https://programmercarl.com/algo/linked-list/0206-reverse-linked-list.html)
- [142.环形链表II](https://programmercarl.com/algo/linked-list/0142-linked-list-cycle-ii.html)
- [344.反转字符串](https://programmercarl.com/algo/string/0344-reverse-string.html)
...
<Tabs items={["Java","Python","Go","JavaScript","PHP"]}>
<Tab>
...
[上一篇：反转字符串](https://programmercarl.com/algo/string/0344-reverse-string.html)·[返回双指针学习路线](https://programmercarl.com/algo/two-pointers/)·[下一篇：翻转字符串里的单词](https://programmercarl.com/algo/string/0151-reverse-words-in-a-string.html)
