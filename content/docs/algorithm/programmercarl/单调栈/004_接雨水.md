...
按照行来计算如图：![42.接雨水2](https://file1.kamacoder.com/i/algo/20210402091118927.png)

按照列来计算如图：![42.接雨水1](https://file1.kamacoder.com/i/algo/20210402091208445.png)
...
关于单调栈的理论基础，单调栈适合解决什么问题，单调栈的工作过程，大家可以先看这题讲解[739. 每日温度](https://programmercarl.com/algo/monotonic-stack/0739-daily-temperatures.html)。

单调栈就是保持栈内元素有序。和[栈与队列：单调队列](https://programmercarl.com/algo/stack-queue/0239-sliding-window-maximum.html)一样，需要我们自己维持顺序，没有现成的容器可以用。
...
关于单调栈的顺序给大家一个总结：[739. 每日温度](https://programmercarl.com/algo/monotonic-stack/0739-daily-temperatures.html)中求一个元素右边第一个更大元素，单调栈就是递增的，[84.柱状图中最大的矩形](https://programmercarl.com/algo/monotonic-stack/0084-largest-rectangle-in-histogram.html)求一个元素右边第一个更小元素，单调栈就是递减的。
...
以下操作过程其实和[739. 每日温度](https://programmercarl.com/algo/monotonic-stack/0739-daily-temperatures.html)也是一样的，建议先做[739. 每日温度](https://programmercarl.com/algo/monotonic-stack/0739-daily-temperatures.html)。
