...
大家还记得我们在这篇文章[数组：每次遇到二分法，都是一看就会，一写就废](https://programmercarl.com/algo/array/0704-binary-search.html)中讲解了二分法，提到如果要写出正确的二分法一定要坚持**循环不变量原则**。
...
<Tabs items={["Java","Python","JavaScript","TypeScript","Go","Swift","Rust","PHP","C","Scala","C#","Ruby"]}>
<Tab>
