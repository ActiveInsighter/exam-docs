...
> 学习路径提示：本文主专题为「数组」，同时收录于[双指针学习路线](https://programmercarl.com/algo/two-pointers/)。
...
数组的基础知识可以看这里[程序员算法面试中，必须掌握的数组理论知识](https://programmercarl.com/algo/array/array-basics.html)。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Ruby","Rust","Swift","PHP","C","Kotlin","Scala","C#"]}>
<Tab>
...
[返回双指针学习路线](https://programmercarl.com/algo/two-pointers/)·[下一篇：反转字符串](https://programmercarl.com/algo/string/0344-reverse-string.html)
