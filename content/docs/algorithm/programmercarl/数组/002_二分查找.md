...
如果是没听说过二分法的录友，可以看这张图，先了解二分法的基本过程：
...
- [34.在排序数组中查找元素的第一个和最后一个位置](https://programmercarl.com/algo/other/0034-find-first-and-last-position-of-element-in-sorted-array.html)
- [69.x 的平方根](https://leetcode.cn/problems/sqrtx/)
- [367.有效的完全平方数](https://leetcode.cn/problems/valid-perfect-square/)

## 其他语言版本

<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Ruby","Swift","Rust","C","PHP","C#","Kotlin","Scala"]}>
<Tab>
