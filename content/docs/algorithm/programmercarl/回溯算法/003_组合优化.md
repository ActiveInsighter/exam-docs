...
在[回溯算法：求组合问题！](https://programmercarl.com/algo/backtracking/0077-combinations.html)中，我们通过回溯搜索法，解决了n个数中求k个数的组合问题。

文中的回溯法是可以剪枝优化的，本篇我们继续来看一下题目77. 组合。

链接：https://leetcode.cn/problems/combinations/

**看本篇之前，需要先看[回溯算法：求组合问题！](https://programmercarl.com/algo/backtracking/0077-combinations.html)**。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Rust","C","Swift","Scala"]}>
<Tab>
