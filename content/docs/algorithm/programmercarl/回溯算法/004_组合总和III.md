...
相对于[77. 组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)，无非就是多了一个限制，本题是要找到和为n的k个数的组合，而整个集合已经是固定的了[1,...,9]。

想到这一点了，做过[77. 组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)之后，本题是简单一些了。
...
和[77. 组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)一样，依然需要一维数组path来存放符合条件的结果，二维数组result来存放结果集。
...
本题和[77. 组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)区别之一就是集合固定的就是9个数[1,...,9]，所以for循环固定i&lt;=9

如图：![216.组合总和III](https://file1.kamacoder.com/i/algo/20201123195717975-20230310113546003.png)
...
参照[关于回溯算法，你该了解这些！](https://programmercarl.com/algo/backtracking/backtracking-basics.html)中的模板，不难写出如下C++代码：
...
如图：![216.组合总和III1](https://file1.kamacoder.com/i/algo/2020112319580476.png)
...
和[回溯算法：组合问题再剪剪枝](https://programmercarl.com/algo/backtracking/0077-combinations-optimized.html)一样，for循环的范围也可以剪枝，i &lt;= 9 - (k - path.size()) + 1就可以了。
...
开篇就介绍了本题与[77.组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)的区别，相对来说加了元素总和的限制，如果做完[77.组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)再做本题在合适不过。
