...
大家应该感觉出和[77.组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)遇到的一样的问题，就是这for循环的层数如何写出来，此时又是回溯法登场的时候了。
...
对于回溯法还不了解的同学看这篇：[关于回溯算法，你该了解这些！](https://programmercarl.com/algo/backtracking/backtracking-basics.html)
...
注意这个index可不是[77.组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)和[216.组合总和III](https://programmercarl.com/algo/backtracking/0216-combination-sum-iii.html)中的startIndex了。
...
**注意这里for循环，可不像是在[回溯算法：求组合问题！](https://programmercarl.com/algo/backtracking/0077-combinations.html)和[回溯算法：求组合总和！](https://programmercarl.com/algo/backtracking/0216-combination-sum-iii.html)中从startIndex开始遍历的**。

**因为本题每一个数字代表的是不同集合，也就是求不同集合之间的组合，而[77. 组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)和[216.组合总和III](https://programmercarl.com/algo/backtracking/0216-combination-sum-iii.html)都是求同一个集合中的组合！**
...
关键地方都讲完了，按照[关于回溯算法，你该了解这些！](https://programmercarl.com/algo/backtracking/backtracking-basics.html)中的回溯法模板，不难写出如下C++代码：
...
我不建议把回溯藏在递归的参数里这种写法，很不直观，我在[二叉树：以为使用了递归，其实还隐藏着回溯](https://programmercarl.com/algo/other/recursion-and-backtracking-in-binary-trees.html)这篇文章中也深度分析了，回溯隐藏在了哪里。

所以大家可以按照版本一来写就可以了。

## 总结

本篇将题目的三个要点一一列出，并重点强调了和前面讲解过的[77. 组合](https://programmercarl.com/algo/backtracking/0077-combinations.html)和[216.组合总和III](https://programmercarl.com/algo/backtracking/0216-combination-sum-iii.html)的区别，本题是多个集合求组合，所以在回溯的搜索过程中，都有一些细节需要注意的。

其实本题不算难，但也处处是细节，大家还要自己亲自动手写一写。

## 其他语言版本

<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Rust","C","Swift","Scala","Ruby","C#"]}>
<Tab>
