...
**我们在[关于回溯算法，你该了解这些！](https://programmercarl.com/algo/backtracking/backtracking-basics.html)中说到回溯法解决的问题都可以抽象为树形结构（N叉树），用树形结构来理解回溯就容易多了**。
...
在[关于回溯算法，你该了解这些！](https://programmercarl.com/algo/backtracking/backtracking-basics.html)中我们提到了回溯法三部曲，那么我们按照回溯法三部曲开始正式讲解代码了。
...
还记得我们在[关于回溯算法，你该了解这些！](https://programmercarl.com/algo/backtracking/backtracking-basics.html)中给出的回溯法模板么？
