...
做这道题目之前，最好先把[131.分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)这个做了。

这道题目相信大家刚看的时候，应该会一脸茫然。

其实只要意识到这是切割问题，**切割问题就可以使用回溯搜索法把所有可能性搜出来**，和刚做过的[131.分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)就十分类似了。
...
在[131.分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)中我们就提到切割问题类似组合问题。
...
终止条件和[131.分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)情况就不同了，本题明确要求只会分成4段，所以不能用切割线切到最后作为终止条件，而是分割的段数作为终止条件。
...
在[131.分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)中已经讲过在循环遍历中如何截取子串。
...
在[131.分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)中我列举的分割字符串的难点，本题都覆盖了。

而且本题还需要操作字符串添加逗号作为分隔符，并验证区间的合法性。

可以说是[131.分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)的加强版。
