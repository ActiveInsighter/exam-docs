...
这道题目和[39.组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)如下区别：
...
最后本题和[39.组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)要求一样，解集不能包含重复的组合。
...
与[39.组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)套路相同，此题还需要加一个bool型数组used，用来记录同一树枝上的元素是否使用过。
...
与[39.组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)相同，终止条件为`sum > target`和`sum == target`。
...
这里与[39.组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)最大的不同就是要去重了。
...
本题同样是求组合总和，但就是因为其数组candidates有重复元素，而要求不能有重复的组合，所以相对于[39.组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)难度提升了不少。
