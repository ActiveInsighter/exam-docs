...
本题和[动态规划：718. 最长重复子数组](https://programmercarl.com/algo/dynamic-programming/0718-maximum-length-of-repeated-subarray.html)区别在于这里不要求是连续的了，但要有相对顺序，即："ace" 是 "abcde" 的子序列，但 "aec" 不是 "abcde" 的子序列。
...
这样定义是为了后面代码实现方便，如果非要定义为长度为[0, i]的字符串text1也可以，我在[动态规划：718. 最长重复子数组](https://programmercarl.com/algo/dynamic-programming/0718-maximum-length-of-repeated-subarray.html)中的「拓展」里 详细讲解了区别所在，其实就是简化了dp数组第一行和第一列的初始化逻辑。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Rust","C"]}>
<Tab>
