...
- [01背包理论基础（二维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)
- [01背包理论基础（一维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-2.html)
...
这里依然拿dp[1][4]的状态来举例： （[01背包理论基础（二维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中也是这个例子，要注意下面的不同之处）
...
容量为1，只考虑放物品0 和物品1 的最大价值是 dp[1][1]，**注意 这里和[01背包理论基础（二维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)有所不同了**！

在[01背包理论基础（二维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中，背包先空留出物品1的容量，此时容量为1，只考虑放物品0的最大价值是 dp[0][1]，**因为01背包每个物品只有一个，既然空出物品1，那背包中也不会再有物品1**！
...
（**注意上图和[01背包理论基础（二维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中的区别**，对于理解完全背包很重要）
...
（注意上面初始化和[01背包理论基础（二维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)的区别在于物品有无限个）
...
[01背包理论基础（二维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中我们讲过，01背包二维DP数组，先遍历物品还是先遍历背包都是可以的。

因为两种遍历顺序，对于二维dp数组来说，递推公式所需要的值，二维dp数组里对应的位置都有。

详细可以看[01背包理论基础（二维数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中的 【遍历顺序】的讲解
...
关于一维dp数组，大家看这里：[完全背包一维dp数组讲解](https://programmercarl.com/algo/other/complete-knapsack-one-dimensional.html)
