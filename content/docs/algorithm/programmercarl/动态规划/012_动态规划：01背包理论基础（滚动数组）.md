...
昨天[动态规划：关于01背包问题，你该了解这些！](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中是用二维dp数组来讲解01背包。
...
关于dp数组的定义，我在[01背包理论基础](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)有详细讲解
...
公式是怎么来的 在这里[01背包理论基础](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)有详细讲解。
...
如果把[动态规划：关于01背包问题，你该了解这些！](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)和本篇的内容都理解了，后面我们在做01背包的题目，就会发现非常简单了。
...
<Tabs items={["Java","Python","Go","JavaScript","C"]}>
<Tab>
