...
所以后续我在讲解背包问题的时候，今天这道题还会从背包问题的角度上来再讲一遍。 如果想提前看一下，可以看这篇:[70.爬楼梯完全背包版本](https://programmercarl.com/algo/dynamic-programming/0070-climbing-stairs-complete-knapsack.html)
...
这道题目和[动态规划：斐波那契数](https://programmercarl.com/algo/dynamic-programming/0509-fibonacci-number.html)题目基本是一样的，但是会发现本题相比[动态规划：斐波那契数](https://programmercarl.com/algo/dynamic-programming/0509-fibonacci-number.html)难多了，为什么呢？

关键是[动态规划：斐波那契数](https://programmercarl.com/algo/dynamic-programming/0509-fibonacci-number.html)题目描述就已经把动规五部曲里的递归公式和如何初始化都给出来了，剩下几部曲也自然而然的推出来了。

而本题，就需要逐个分析了，大家现在应该初步感受出[关于动态规划，你该了解这些！](https://programmercarl.com/algo/dynamic-programming/dynamic-programming-basics.html)里给出的动规五部曲了。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","C","Scala","C#","Rust"]}>
<Tab>
