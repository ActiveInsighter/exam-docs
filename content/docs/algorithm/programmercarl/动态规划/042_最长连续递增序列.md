...
本题相对于昨天的[动态规划：300.最长递增子序列](https://programmercarl.com/algo/dynamic-programming/0300-longest-increasing-subsequence.html)最大的区别在于“连续”。
...
**注意这里就体现出和[动态规划：300.最长递增子序列](https://programmercarl.com/algo/dynamic-programming/0300-longest-increasing-subsequence.html)的区别！**
...
在动规分析中，关键是要理解和[动态规划：300.最长递增子序列](https://programmercarl.com/algo/dynamic-programming/0300-longest-increasing-subsequence.html)的区别。
...
<Tabs items={["Java","Python","Go","Rust","JavaScript","TypeScript","C"]}>
<Tab>
