...
如果跟着「代码随想录」一起学过[回溯算法系列](https://programmercarl.com/algo/backtracking/backtracking-summary.html)的录友，看到这道题，应该有一种直觉，就是感觉好像回溯法可以暴搜出来。
...
在回溯算法系列中，一起学过这道题目[回溯算法：39. 组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)的录友应该感觉很熟悉，这不就是组合总和问题么？
...
01背包为什么这么定义dp数组，我在[0-1背包理论基础](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中 确定dp数组的含义里讲解过。
...
这一点我在[01背包理论基础](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-1.html)中的 遍历顺序部分讲过。
...
将二维dp数组压缩成一维dp数组，我们在[01背包理论基础（滚动数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-2.html)讲过滚动数组，原理是一样的，即重复利用每一行的数值。
...
在[动态规划：关于01背包问题，你该了解这些！（滚动数组）](https://programmercarl.com/algo/dynamic-programming/zero-one-knapsack-basics-part-2.html)中，我们系统讲过对于01背包问题一维dp的遍历。
...
此时 大家应该不禁想起，我们之前讲过的[回溯算法：39. 组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)是不是应该也可以用dp来做啊？

是可以求的，如果仅仅是求个数的话，就可以用dp，但[回溯算法：39. 组合总和](https://programmercarl.com/algo/backtracking/0039-combination-sum.html)要求的是把所有组合列出来，还是要使用回溯法暴搜的。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Scala","Rust","C","C#"]}>
<Tab>
 ...
 *
 * 题解来源: {@link /algo/dynamic-programming/0494-target-sum.html
 *
