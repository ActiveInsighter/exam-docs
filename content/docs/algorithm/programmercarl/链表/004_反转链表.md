...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Ruby","Kotlin","Swift","C","PHP","Scala","Rust","C#"]}>
<Tab>
...
> 采用这种方法需要注意一点。就是当整个出栈循环结束以后，cur正好指向原来链表的第一个结点，而此时结点1中的next指向的是结点2，因此最后还需要`cur.next = null`![image-20230117195418626](https://raw.githubusercontent.com/liyuxuan7762/MyImageOSS/master/md_images/image-20230117195418626.png)

## 双指针学习路线导航

[上一篇：翻转字符串里的单词](https://programmercarl.com/algo/string/0151-reverse-words-in-a-string.html)·[返回双指针学习路线](https://programmercarl.com/algo/two-pointers/)·[下一篇：删除链表的倒数第N个节点](https://programmercarl.com/algo/linked-list/0019-remove-nth-node-from-end-of-list.html)
