...
本题相对于[55.跳跃游戏](https://programmercarl.com/algo/greedy/0055-jump-game.html)还是难了不少。
...
- 如果移动下标等于当前覆盖最大距离下标， 需要再走一步（即 ans++），因为最后一步一定是可以到的终点。（题目假设总是可以到达数组的最后一个位置），如图：![45.跳跃游戏II2](https://file1.kamacoder.com/i/algo/20201201232445286.png)
...
相信大家可以发现，这道题目相当于[55.跳跃游戏](https://programmercarl.com/algo/greedy/0055-jump-game.html)难了不止一点。
