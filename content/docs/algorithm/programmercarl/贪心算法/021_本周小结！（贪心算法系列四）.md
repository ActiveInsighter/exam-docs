...
在[贪心算法：用最少数量的箭引爆气球](https://programmercarl.com/algo/greedy/0452-minimum-number-of-arrows-to-burst-balloons.html)中，我们开始讲解了重叠区间问题，用最少的弓箭射爆所有气球，其本质就是找到最大的重叠区间。
...
在[贪心算法：无重叠区间](https://programmercarl.com/algo/greedy/0435-non-overlapping-intervals.html)中要去掉最少的区间，来让所有区间没有重叠。
...
细心的同学就发现了，此题和[贪心算法：用最少数量的箭引爆气球](https://programmercarl.com/algo/greedy/0452-minimum-number-of-arrows-to-burst-balloons.html)非常像。

弓箭的数量就相当于是非交叉区间的数量，只要把弓箭那道题目代码里射爆气球的判断条件加个等号（认为[0，1][1，2]不是相邻区间），然后用总区间数减去弓箭数量 就是要移除的区间数量了。

把[贪心算法：用最少数量的箭引爆气球](https://programmercarl.com/algo/greedy/0452-minimum-number-of-arrows-to-burst-balloons.html)代码稍做修改，就可以AC本题。
...
[贪心算法：划分字母区间](https://programmercarl.com/algo/greedy/0763-partition-labels.html)中我们要把这个字符串划分为尽可能多的片段，同一字母最多出现在一个片段中。
...
[贪心算法：合并区间](https://programmercarl.com/algo/greedy/0056-merge-intervals.html)中要合并所有重叠的区间。
...
在[贪心算法：合并区间](https://programmercarl.com/algo/greedy/0056-merge-intervals.html)中就说过，对于贪心算法，很多同学都是：「如果能凭常识直接做出来，就会感觉不到自己用了贪心, 一旦第一直觉想不出来, 可能就一直想不出来了」。
