...
我们都知道，有递归就有回溯，回溯就在递归函数的下面， 那么之前我们做的dfs题目，都需要回溯操作，例如：[797.所有可能的路径](https://programmercarl.com/algo/other/0797-all-paths-from-source-to-target.html)，**为什么本题就没有回溯呢？**
...
当我们需要搜索一条可行路径的时候，就需要回溯操作了，因为没有回溯，就没法“调头”， 如果不理解的话，去看我写的[797.所有可能的路径](https://programmercarl.com/algo/other/0797-all-paths-from-source-to-target.html)的题解。
