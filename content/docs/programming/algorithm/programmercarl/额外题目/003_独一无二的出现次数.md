...
这道题目数组在是哈希法中的经典应用，如果对数组在哈希法中的使用还不熟悉的同学可以看这两篇：[数组在哈希法中的应用](https://programmercarl.com/algo/hash-table/0242-valid-anagram.html)和[哈希法：383. 赎金信](https://programmercarl.com/algo/hash-table/0383-ransom-note.html)

进而可以学习一下[set在哈希法中的应用](https://programmercarl.com/algo/hash-table/0349-intersection-of-two-arrays.html)，以及[map在哈希法中的应用](https://programmercarl.com/algo/hash-table/0001-two-sum.html)
...
![](https://file1.kamacoder.com/i/algo/1207.独一无二的出现次数.png)
