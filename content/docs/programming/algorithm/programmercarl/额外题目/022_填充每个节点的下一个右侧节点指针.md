...
![](https://file1.kamacoder.com/i/algo/116.填充每个节点的下一个右侧节点指针1.png)
...
本题使用层序遍历是最为直观的，如果对层序遍历不了解，看这篇：[二叉树：层序遍历登场！](https://programmercarl.com/algo/binary-tree/0102-binary-tree-level-order-traversal.html)。
