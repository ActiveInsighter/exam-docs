...
这道题目一看就是要使用栈的节奏，这种匹配（消除）问题也是栈的擅长所在，跟着一起刷题的同学应该知道，在[栈与队列：匹配问题都是栈的强项](https://programmercarl.com/algo/stack-queue/1047-remove-all-adjacent-duplicates-in-string.html)，我就已经提过了一次使用栈来做类似的事情了。
...
![](https://file1.kamacoder.com/i/algo/844.比较含退格的字符串.gif)
