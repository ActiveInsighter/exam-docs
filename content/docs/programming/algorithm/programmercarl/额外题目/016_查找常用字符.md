...
那我们还是哈希法吧。如果对哈希法不了解，可以看这篇：[关于哈希表，你该了解这些！](https://programmercarl.com/algo/hash-table/hash-table-basics.html)。

如果对用数组来做哈希法不了解的话，可以看这篇：[把数组当做哈希表来用，很巧妙！](https://programmercarl.com/algo/hash-table/0242-valid-anagram.html)。
...
![1002.查找常用字符](https://file1.kamacoder.com/i/algo/1002.%E6%9F%A5%E6%89%BE%E5%B8%B8%E7%94%A8%E5%AD%97%E7%AC%A6.png)
...
<Tabs items={["Java","Python","JavaScript","TypeScript","Go","Swift","C","Scala","Rust"]}>
<Tab>
