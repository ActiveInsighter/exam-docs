...
本题和[647.回文子串](https://programmercarl.com/algo/dynamic-programming/0647-palindromic-substrings.html)差不多是一样的，但647.回文子串更基本一点，建议可以先做647.回文子串
...
<Tabs items={["Java","Python","Go","JavaScript","C","C#"]}>
<Tab>
