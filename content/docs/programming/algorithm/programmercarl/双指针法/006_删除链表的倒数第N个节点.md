...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Kotlin","Swift","PHP","Scala","Rust","C","C#"]}>
<Tab>
...
[上一篇：翻转链表](https://programmercarl.com/algo/linked-list/0206-reverse-linked-list.html)·[返回双指针学习路线](https://programmercarl.com/algo/two-pointers/)·[下一篇：链表相交](https://programmercarl.com/algo/linked-list/interview-02-07-linked-list-intersection.html)
