...
刚刚做过[栈与队列：我用栈来实现队列怎么样？](https://programmercarl.com/algo/stack-queue/0232-implement-queue-using-stacks.html)的同学可能依然想着用一个输入队列，一个输出队列，就可以模拟栈的功能，仔细想一下还真不行！
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Swift","Scala","C#","PHP","Rust","C"]}>
<Tab>
