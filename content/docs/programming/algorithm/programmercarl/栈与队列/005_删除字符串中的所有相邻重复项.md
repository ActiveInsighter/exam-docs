...
本题要删除相邻相同元素，相对于[20. 有效的括号](https://programmercarl.com/algo/stack-queue/0020-valid-parentheses.html)来说其实也是匹配问题，20. 有效的括号 是匹配左右括号，本题是匹配相邻元素，最后都是做消除的操作。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","C","Swift","C#","PHP","Scala","Rust","Ruby"]}>
<Tab>
