...
如果对链表的基础知识还不太懂，可以看这篇文章：[关于链表，你该了解这些！](https://programmercarl.com/algo/linked-list/linked-list-basics.html)

如果对链表的虚拟头结点不清楚，可以看这篇文章：[链表：听说用虚拟头节点会方便很多？](https://programmercarl.com/algo/linked-list/0203-remove-linked-list-elements.html)
...
<Tabs items={["C","Java","Python","Go","JavaScript","TypeScript","Kotlin","Swift","Scala","Rust","C#"]}>
<Tab>
