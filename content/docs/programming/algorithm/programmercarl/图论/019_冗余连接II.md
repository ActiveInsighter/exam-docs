...
**[《代码随想录》算法视频公开课](https://programmercarl.com/about/gongkaike.html)：[图论：并查集这次要上难度了 | 卡码网：109. 冗余的边II](https://www.bilibili.com/video/BV1t2NEzaEMR/),相信结合视频再看本篇题解，更有助于大家对本题的理解**。

本题与[108.冗余连接](https://programmercarl.com/algo/graph/kamacoder-0108-redundant-connection.html)类似，但本题是一个有向图，有向图相对要复杂一些。
...
如果还不了解并查集，可以看这里：[并查集理论基础](https://programmercarl.com/algo/graph/union-find-basics.html)
