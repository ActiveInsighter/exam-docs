...
看到这道题目的时候，大家应该回想起我们之前讲解回溯法专题的时候，讲过的一道题目[回溯算法：分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)，就是枚举字符串的所有分割情况。

[回溯算法：分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)：是枚举分割后的所有子串，判断是否回文。
...
本题和我们之前讲解回溯专题的[回溯算法：分割回文串](https://programmercarl.com/algo/backtracking/0131-palindrome-partitioning.html)非常像，所以我也给出了对应的回溯解法。

稍加分析，便可知道本题是完全背包，是求能否组成背包，而且这里要求物品是要有顺序的。

## 其他语言版本

<Tabs items={["Java","Python","Go","JavaScript","TypeScript","C","Rust"]}>
<Tab>
