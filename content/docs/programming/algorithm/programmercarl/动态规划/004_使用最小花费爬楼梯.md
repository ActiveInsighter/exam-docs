...
大家可以发现这道题目相对于 昨天的[动态规划：爬楼梯](https://programmercarl.com/algo/dynamic-programming/0070-climbing-stairs.html)又难了一点，但整体思路是一样的。

从[动态规划：斐波那契数](https://programmercarl.com/algo/dynamic-programming/0509-fibonacci-number.html)到[动态规划：爬楼梯](https://programmercarl.com/algo/dynamic-programming/0070-climbing-stairs.html)再到今天这道题目，录友们感受到循序渐进的梯度了嘛。
