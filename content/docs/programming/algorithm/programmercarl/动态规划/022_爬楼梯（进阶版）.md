...
这道题目 我们在[动态规划：爬楼梯](https://programmercarl.com/algo/dynamic-programming/0070-climbing-stairs.html)中已经讲过一次了，这次我又给本题加点料，力扣上没有原题，所以可以在卡码网[57. 爬楼梯](https://kamacoder.com/problempage.php?pid=1067)上来刷这道题目。
...
和昨天的题目[动态规划：377. 组合总和 Ⅳ](https://programmercarl.com/algo/dynamic-programming/0377-combination-sum-iv.html)基本就是一道题了。
...
在[动态规划：494.目标和](https://programmercarl.com/algo/dynamic-programming/0494-target-sum.html)、[动态规划：518.零钱兑换II](https://programmercarl.com/algo/dynamic-programming/0518-coin-change-ii.html)、[动态规划：377. 组合总和 Ⅳ](https://programmercarl.com/algo/dynamic-programming/0377-combination-sum-iv.html)中我们都讲过了，求装满背包有几种方法，递推公式一般都是dp[i] += dp[i - nums[j]];
...
介于本题和[动态规划：377. 组合总和 Ⅳ](https://programmercarl.com/algo/dynamic-programming/0377-combination-sum-iv.html)几乎是一样的，这里我就不再重复举例了。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript"]}>
<Tab>
