...
本题我们在讲解贪心专题的时候就已经讲解过了[贪心算法：买卖股票的最佳时机II](https://programmercarl.com/algo/greedy/0122-best-time-to-buy-and-sell-stock-ii.html)，只不过没有深入讲解动态规划的解法，那么这次我们再好好分析一下动规的解法。

本题和[121. 买卖股票的最佳时机](https://programmercarl.com/algo/dynamic-programming/0121-best-time-to-buy-and-sell-stock.html)的唯一区别是本题股票可以买卖多次了（注意只有一只股票，所以再次购买前要出售掉之前的股票）

**在动规五部曲中，这个区别主要是体现在递推公式上，其他都和[121. 买卖股票的最佳时机](https://programmercarl.com/algo/dynamic-programming/0121-best-time-to-buy-and-sell-stock.html)一样一样的**。
...
**注意这里和[121. 买卖股票的最佳时机](https://programmercarl.com/algo/dynamic-programming/0121-best-time-to-buy-and-sell-stock.html)就是一样的逻辑，卖出股票收获利润（可能是负值）天经地义！**
...
大家可以本题和[121. 买卖股票的最佳时机](https://programmercarl.com/algo/dynamic-programming/0121-best-time-to-buy-and-sell-stock.html)的代码几乎一样，唯一的区别在：
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","C#","C","Rust"]}>
<Tab>
