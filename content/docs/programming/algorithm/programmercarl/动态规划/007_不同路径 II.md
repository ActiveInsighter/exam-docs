...
这道题相对于[62.不同路径](https://programmercarl.com/algo/dynamic-programming/0062-unique-paths.html)就是有了障碍。

第一次接触这种题目的同学可能会有点懵，这有障碍了，应该怎么算呢？

[62.不同路径](https://programmercarl.com/algo/dynamic-programming/0062-unique-paths.html)中我们已经详细分析了没有障碍的情况，有障碍的话，其实就是标记对应的dp table（dp数组）保持初始值(0)就可以了。
...
在[62.不同路径](https://programmercarl.com/algo/dynamic-programming/0062-unique-paths.html)不同路径中我们给出如下的初始化：
...
本题是[62.不同路径](https://programmercarl.com/algo/dynamic-programming/0062-unique-paths.html)的障碍版，整体思路大体一致。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Rust","C","Scala","C#"]}>
<Tab>
