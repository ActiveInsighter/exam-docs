...
这道题目和[198.打家劫舍](https://programmercarl.com/algo/dynamic-programming/0198-house-robber.html)是差不多的，唯一区别就是成环了。
...
分析到这里，本题其实比较简单了。 剩下的和[198.打家劫舍](https://programmercarl.com/algo/dynamic-programming/0198-house-robber.html)就是一样的了。
