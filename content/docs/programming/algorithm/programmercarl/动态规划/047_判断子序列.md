...
为什么这么定义我在[718. 最长重复子数组](https://programmercarl.com/algo/dynamic-programming/0718-maximum-length-of-repeated-subarray.html)中做了详细的讲解。
...
其实这里 大家可以发现和[1143.最长公共子序列](https://programmercarl.com/algo/dynamic-programming/1143-longest-common-subsequence.html)的递推公式基本那就是一样的，区别就是 本题 如果删元素一定是字符串t，而 1143.最长公共子序列 是两个字符串都可以删元素。
...
在之前的题目讲解中，我们讲了[1143.最长公共子序列](https://programmercarl.com/algo/dynamic-programming/1143-longest-common-subsequence.html)，大家会发现 本题和 1143.最长公共子序列 的相似之处。

编辑距离的题目最能体现出动规精髓和巧妙之处，大家可以好好体会一下。

## 其他语言版本

<Tabs items={["Java","Python","JavaScript","TypeScript","Go","Rust"]}>
<Tab>
