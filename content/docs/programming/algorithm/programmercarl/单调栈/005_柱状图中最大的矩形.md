...
本题和[42. 接雨水](https://programmercarl.com/algo/monotonic-stack/0042-trapping-rain-water.html)，是遥相呼应的两道题目，建议都要仔细做一做，原理上有很多相同的地方，但细节上又有差异，更可以加深对单调栈的理解！

其实这两道题目先做那一道都可以，但我先写的42.接雨水的题解，所以如果没做过接雨水的话，建议先做一做接雨水，可以参考我的题解：[42. 接雨水](https://programmercarl.com/algo/monotonic-stack/0042-trapping-rain-water.html)
...
本题双指针的写法整体思路和[42. 接雨水](https://programmercarl.com/algo/monotonic-stack/0042-trapping-rain-water.html)是一致的，但要比[42. 接雨水](https://programmercarl.com/algo/monotonic-stack/0042-trapping-rain-water.html)难一些。

难就难在本题要记录记录每个柱子 左边第一个小于该柱子的下标，而不是左边第一个小于该柱子的高度。

所以需要循环查找，也就是下面在寻找的过程中使用了while，详细请看下面注释，整理思路在题解：[42. 接雨水](https://programmercarl.com/algo/monotonic-stack/0042-trapping-rain-water.html)中已经介绍了。
...
为什么这么说呢，[42. 接雨水](https://programmercarl.com/algo/monotonic-stack/0042-trapping-rain-water.html)是找每个柱子左右两边第一个大于该柱子高度的柱子，而本题是找每个柱子左右两边第一个小于该柱子的柱子。

**这里就涉及到了单调栈很重要的性质，就是单调栈里的顺序，是从小到大还是从大到小**。

在题解[42. 接雨水](https://programmercarl.com/algo/monotonic-stack/0042-trapping-rain-water.html)中我讲解了接雨水的单调栈从栈头（元素从栈头弹出）到栈底的顺序应该是从小到大的顺序。
...
除了栈内元素顺序和接雨水不同，剩下的逻辑就都差不多了，在题解[42. 接雨水](https://programmercarl.com/algo/monotonic-stack/0042-trapping-rain-water.html)我已经对单调栈的各个方面做了详细讲解，这里就不赘述了。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Rust"]}>
<Tab>
