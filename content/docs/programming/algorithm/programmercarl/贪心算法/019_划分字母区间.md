...
这里提供一种与[452.用最少数量的箭引爆气球](https://programmercarl.com/algo/greedy/0452-minimum-number-of-arrows-to-burst-balloons.html)、[435.无重叠区间](https://programmercarl.com/algo/greedy/0435-non-overlapping-intervals.html)相同的思路。

统计字符串中所有字符的起始和结束位置，记录这些区间(实际上也就是[435.无重叠区间](https://programmercarl.com/algo/greedy/0435-non-overlapping-intervals.html)题目里的输入)，**将区间按左边界从小到大排序，找到边界将区间划分成组，互不重叠。找到的边界就是答案。**
