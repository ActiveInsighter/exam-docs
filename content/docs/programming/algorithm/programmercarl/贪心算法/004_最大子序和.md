...
当然本题还可以用动态规划来做，在代码随想录动态规划章节我会详细介绍，如果大家想在想看，可以直接跳转：[动态规划版本详解](https://programmercarl.com/algo/dynamic-programming/0053-maximum-subarray-dynamic-programming.html#思路)
...
<Tabs items={["Java","Python","Go","Rust","JavaScript","C","TypeScript","Scala","C#"]}>
<Tab>
