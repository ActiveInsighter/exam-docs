...
本题其实和[452.用最少数量的箭引爆气球](https://programmercarl.com/algo/greedy/0452-minimum-number-of-arrows-to-burst-balloons.html)非常像，弓箭的数量就相当于是非交叉区间的数量，只要把弓箭那道题目代码里射爆气球的判断条件加个等号（认为[0，1][1，2]不是相邻区间），然后用总区间数减去弓箭数量 就是要移除的区间数量了。

把[452.用最少数量的箭引爆气球](https://programmercarl.com/algo/greedy/0452-minimum-number-of-arrows-to-burst-balloons.html)代码稍做修改，就可以AC本题。
