...
再来看看迭代法，对二叉搜索树迭代写法不熟悉，可以看这篇：[二叉树：二叉搜索树登场！](https://programmercarl.com/algo/binary-tree/0700-search-in-a-binary-search-tree.html)

在迭代法遍历的过程中，需要记录一下当前遍历的节点的父节点，这样才能做插入节点的操作。

在[二叉树：搜索树的最小绝对差](https://programmercarl.com/algo/binary-tree/0530-minimum-absolute-difference-in-bst.html)和[二叉树：我的众数是多少？](https://programmercarl.com/algo/binary-tree/0501-find-mode-in-binary-search-tree.html)中，都是用了记录pre和cur两个指针的技巧，本题也是一样的。
