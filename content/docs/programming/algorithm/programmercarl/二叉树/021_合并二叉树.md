...
思路我们在[二叉树：我对称么？](https://programmercarl.com/algo/binary-tree/0101-symmetric-tree.html)中的迭代法已经讲过一次了，求二叉树对称的时候就是把两个树的节点同时加入队列进行比较。
...
这不是我们第一次操作两棵二叉树了，在[二叉树：我对称么？](https://programmercarl.com/algo/binary-tree/0101-symmetric-tree.html)中也一起操作了两棵二叉树。
