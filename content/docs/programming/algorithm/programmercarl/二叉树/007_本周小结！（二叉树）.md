...
本周我们开始讲解了二叉树，在[关于二叉树，你该了解这些！](https://programmercarl.com/algo/binary-tree/binary-tree-basics.html)中讲解了二叉树的理论基础。
...
在[二叉树：一入递归深似海，从此offer是路人](https://programmercarl.com/algo/binary-tree/recursive-binary-tree-traversal.html)中讲到了递归三要素，以及前中后序的递归写法。

文章中我给出了leetcode上三道二叉树的前中后序题目，但是看完[二叉树：一入递归深似海，从此offer是路人](https://programmercarl.com/algo/binary-tree/recursive-binary-tree-traversal.html)，依然可以解决n叉树的前后序遍历，在leetcode上分别是
...
在[二叉树：听说递归能做的，栈也能做！](https://programmercarl.com/algo/binary-tree/iterative-binary-tree-traversal.html)中我们开始用栈来实现递归的写法，也就是所谓的迭代法。
...
在[二叉树：前中后序迭代方式的写法就不能统一一下么？](https://programmercarl.com/algo/binary-tree/unified-iterative-binary-tree-traversal.html)中我们使用空节点作为标记，给出了统一的前中后序迭代法。
...
在[二叉树：层序遍历登场！](https://programmercarl.com/algo/binary-tree/0102-binary-tree-level-order-traversal.html)中我们介绍了二叉树的另一种遍历方式（图论中广度优先搜索在二叉树上的应用）即：层序遍历。
...
在[二叉树：你真的会翻转二叉树么？](https://programmercarl.com/algo/binary-tree/0226-invert-binary-tree.html)中我们把翻转二叉树这么一道简单又经典的问题，充分的剖析了一波，相信就算做过这道题目的同学，看完本篇之后依然有所收获！
