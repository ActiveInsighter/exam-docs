...
做过[二叉树：公共祖先问题](https://programmercarl.com/algo/binary-tree/0236-lowest-common-ancestor-of-a-binary-tree.html)题目的同学应该知道，利用回溯从底向上搜索，遇到一个节点的左子树里有p，右子树里有q，那么当前节点就是最近公共祖先。
...
在[二叉树：公共祖先问题](https://programmercarl.com/algo/binary-tree/0236-lowest-common-ancestor-of-a-binary-tree.html)中，如果递归函数有返回值，如何区分要搜索一条边，还是搜索整个树。
...
对于二叉搜索树的迭代法，大家应该在[二叉树：二叉搜索树登场！](https://programmercarl.com/algo/binary-tree/0700-search-in-a-binary-search-tree.html)就了解了。
...
对于二叉搜索树的最近祖先问题，其实要比[普通二叉树公共祖先问题](https://programmercarl.com/algo/binary-tree/0236-lowest-common-ancestor-of-a-binary-tree.html)简单的多。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Scala","Rust","C#"]}>
<Tab>
