...
和文章[二叉树：构造二叉树登场！](https://programmercarl.com/algo/binary-tree/0106-construct-binary-tree-from-inorder-and-postorder-traversal.html)中一样的优化思路，就是每次分隔不用定义新的数组，而是通过下标索引直接在原数组上操作。
...
这道题目其实和[二叉树：构造二叉树登场！](https://programmercarl.com/algo/binary-tree/0106-construct-binary-tree-from-inorder-and-postorder-traversal.html)是一个思路，比[二叉树：构造二叉树登场！](https://programmercarl.com/algo/binary-tree/0106-construct-binary-tree-from-inorder-and-postorder-traversal.html)还简单一些。
...
<Tabs items={["Java","Python","Go","JavaScript","TypeScript","C","Swift","Scala","Rust","C#"]}>
<Tab>
