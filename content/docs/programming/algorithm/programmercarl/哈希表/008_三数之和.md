...
既然三数之和可以使用双指针法，我们之前讲过的[1.两数之和](https://programmercarl.com/algo/hash-table/0001-two-sum.html)，可不可以使用双指针法呢？

如果不能，题意如何更改就可以使用双指针法呢？**大家留言说出自己的想法吧！**

两数之和 就不能使用双指针法，因为[1.两数之和](https://programmercarl.com/algo/hash-table/0001-two-sum.html)要求返回的是索引下标， 而双指针法一定要排序，一旦排序之后原数组的索引就被改变了。

如果[1.两数之和](https://programmercarl.com/algo/hash-table/0001-two-sum.html)要求返回的是数值的话，就可以使用双指针法了。

## 其他语言版本

<Tabs items={["Java","Python","Go","JavaScript","TypeScript","Ruby","PHP","Swift","Rust","C","C#","Scala"]}>
<Tab>
...
[上一篇：环形链表II](https://programmercarl.com/algo/linked-list/0142-linked-list-cycle-ii.html)·[返回双指针学习路线](https://programmercarl.com/algo/two-pointers/)·[下一篇：四数之和](https://programmercarl.com/algo/hash-table/0018-4sum.html)
