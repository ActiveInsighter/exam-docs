...
- [242. 有效的字母异位词](https://programmercarl.com/algo/hash-table/0242-valid-anagram.html)
- [349. 两个数组的交集](https://programmercarl.com/algo/hash-table/0349-intersection-of-two-arrays.html)

[242. 有效的字母异位词](https://programmercarl.com/algo/hash-table/0242-valid-anagram.html)这道题目是用数组作为哈希表来解决哈希问题，[349. 两个数组的交集](https://programmercarl.com/algo/hash-table/0349-intersection-of-two-arrays.html)这道题目是通过set作为哈希表来解决哈希问题。
...
同理，std::map 和std::multimap 的key也是有序的（这个问题也经常作为面试题，考察对语言容器底层的理解）。 更多哈希表的理论知识请看[关于哈希表，你该了解这些！](https://programmercarl.com/algo/hash-table/hash-table-basics.html)。
...
<Tabs items={["Java","Python","Go","Rust","JavaScript","TypeScript","PHP","Swift","Scala","C#","Dart","C"]}>
<Tab>
